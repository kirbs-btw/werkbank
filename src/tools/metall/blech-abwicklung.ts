...
export const tool: Tool = {
  ...
  description: 'Berechne die gestreckte Länge und Biegezugabe beim Blechbiegen aus Schenkellängen, Biegewinkel, Innenradius, Dicke und K-Faktor.',
  ...
  compute: (v) => {
    ...
    return [
      { label: 'Gestreckte Länge', value: gestreckt, unit: 'mm', digits: 2, primary: true },
      { label: 'Biegezugabe', value: ba, unit: 'mm', digits: 2 },
    ];
  },
  intro: 'Berechne die Zuschnittlänge für ein gebogenes Blechteil über die neutrale Faser und den K-Faktor.',
  howto: [
    'Beide Schenkellängen in mm eingeben.',
  ...
  faq: [
    ...
    { q: 'Wie werden Schenkel gemessen?', a: 'Die Schenkellängen werden bis zur theoretischen Biegekante als Außenmaße minus Verkürzung verwendet, hier vereinfacht als Geradenanteil.' },
  ],
  ...
  examples: [
    {
      ...
      expect: [
        ...
        { label: 'Gestreckte Länge', value: 104.398, tolerance: 0.01 },
      ],
    },
  ],
};
